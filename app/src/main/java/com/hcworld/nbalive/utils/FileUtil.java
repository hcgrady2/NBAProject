...
public class FileUtil {
    ...
    public static void writeLogCrashContent(final String content) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                FileUtil.writeFile(getFileDir("Log") + "/crash.log", DateUtils.getCurDate() + " : " + content, true);
            }
        }).start();
    }
    ...
    public static String getFileDir(String filePath) {
        String dir;
        if (isExistSDCard()) {
            dir = AppApplication.getContext().getExternalFilesDir("").getAbsolutePath();
        } else {
            dir = AppApplication.getContext().getFilesDir().getAbsolutePath();
        }
