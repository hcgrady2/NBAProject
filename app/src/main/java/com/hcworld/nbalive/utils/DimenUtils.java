...
public class DimenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * AppApplication.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / AppApplication.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / AppApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * AppApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
}
